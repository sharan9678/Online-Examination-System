    ...
    <?php
        if (isset($_POST['studsu'])) {
            ...
            if (isset($_POST['name1']) && isset($_POST['usn1']) && isset($_POST['mail1']) && isset($_POST['phno1']) && isset($_POST['dept1']) && isset($_POST['dob1']) && isset($_POST['gender1']) && isset($_POST['password1']) && isset($_POST['cpassword1'])) {
                ...
                $password1 = crypt($password1,'sharanraj');
                $cpassword1 = crypt($cpassword1,'sharanraj');
        ...
        require 'sql.php';
                ...
                $password2 = crypt($password2,'sharanraj');
                $cpassword2 = crypt( $cpassword2,'sharanraj');
...
<body>
    <div class="bg">
        <center>
            <h1 id="heading">Online Examination System</h1>
        </center>
        <div class="seluser">
            <center>
        ...
        <div class="stud" id="stud">
            <center>
                <form name="student" method="POST" style="width: 80vw;background-color:#fff;"><br>
                    ...
                    <select name="dept1" class="selc" required style="height: 4vw;">
