...
<head>
    ...
    <link rel="stylesheet" href="styles/homestud.css">
    <?php 
        session_start();
...
<body>
    <div style="background-color: #042A38;height: auto;">
        ...
        ?>
        <center>
            <section style="width:100vw;margin:0vw;margin-top:5vw;font-size:3vw;">Welcome to Online Examination System&nbsp;<?php echo $dbname ?></section>
        </center>
